...
class ValidConfig(object):
      validConfigItems = ["defImportFile","defExportFile","playerName","location","debug","strict","files","debugFile","moveConfirm"]
      ...
      configMap = {"import":ImportFile, "export":ExportFile, "name":PlayerName, \
                   ...
                   "files":FileDir, "debugFile":DebugFile, "confirm":Confirm}
